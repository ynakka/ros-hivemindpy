...
def control_allocation(theta,control_force_inertial,system_param,\
    thruster_force_desired = np.zeros((8,1)),cvx=False,pseudoinv = True):
    ...
    if pseudoinv == True:
        ...
        thruster_force = thruster_force_desired + inv_force @ rotate_inertialframe_to_bodyframe @ inv_allocation # thruster force 
...
def thruster_model_force_to_times(thruster_force,control_frequency,a,b):
...
def thruster_linear_force_to_times(thruster_force,control_frequency,thrust_min, thrust_max,min_impulse_bit,max_impulse_bit):
